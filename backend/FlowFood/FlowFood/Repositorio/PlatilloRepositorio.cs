...
namespace FlowFood.Repositorio
{
    public class PlatilloRepositorio : IPlatilloRepositorio
    {
        ...
        // Generacion del codigo consecutivo PLA00001, PLA00002, ...
        public async Task<string> GenerarSiguienteCodigoAsync()
        {
            ...
            // Quitamos el prefijo "PLA" y tomamos la parte numerica
        ...
        {
            var platilloExistente = await _context.Platillos.AsNoTracking().FirstOrDefaultAsync(p => p.Id == platillo.Id);
